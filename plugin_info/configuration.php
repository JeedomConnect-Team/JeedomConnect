    ...
    <div class="turnModeSection" data-mode="cloudflare">
      ...
      <div class="row">
        <div class="form-group col-lg-6">
          ...
          <div class="col-lg-6">
            <input class="configKey form-control needJCRefresh" type="string" data-l1key="cloudflareTurnKeyId" />
          </div>
        </div>
        <div class="form-group col-lg-6">
          ...
          <div class="col-lg-6">
            <input class="configKey form-control needJCRefresh" type="password" autocomplete="new-password" data-l1key="cloudflareTurnApiToken" />
          </div>
        </div>
      </div>
      <div class="row">
